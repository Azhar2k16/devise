...
Devise.setup do |config|
  ...
  # config.secret_key = '69f996e3000b0e46fc79f41515051760b5e1f00290a831140da91c814575af1d8257454ccf1377ad33e3afed05b7ce90c601e5ff26123b9dcc55db8242add731'
  ...
  # config.pepper = 'b8d4879bb82e7e5559fa11dbe337558921cd34933dce6279db670ad75bedcbcc710061e9d68797b2530ada468cc4ccb02c50c27f05c62b180cb53519e04bf514'
  ...
  # config.omniauth Rails.application.credentials[Rails.env.to_sym][:twitter][:access_key_id], Rails.application.credentials[Rails.env.to_sym][:twitter][:secret_access_key]
